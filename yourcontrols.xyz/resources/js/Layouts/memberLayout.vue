<template>
    <v-app id="inspire" dark>
        <v-navigation-drawer app dark clipped v-model="drawer" dense>
            <v-list>
                ...
                >
                    ...
                    <inertia-link
                        as="v-list-item"
                        href="/member-area/bugs/view"
                        :class="{
                            'v-item--active v-list-item--active':
                                path == '/member-area/bugs/view'
                        }"
                        color="#fff"
                    >
                        <v-list-item-icon>
                    ...
                    <inertia-link
                        as="v-list-item"
                        href="/member-area/bugs/submit"
                        :class="{
                            'v-item--active v-list-item--active':
                                path == '/member-area/bugs/submit'
                        }"
                        color="#fff"
                    >
                        <v-list-item-icon>
                ...
                >
                    ...
                    <inertia-link
                        as="v-list-item"
                        href="/member-area/suggestions/view"
                        :class="{
                            'v-item--active v-list-item--active':
                                path == '/member-area/suggestions/view'
                        }"
                        color="#fff"
                    >
                        <v-list-item-icon>
                    ...
                    <inertia-link
                        as="v-list-item"
                        href="/member-area/suggestions/submit"
                        :class="{
                            'v-item--active v-list-item--active':
                                path == '/member-area/suggestions/submit'
                        }"
                        color="#fff"
                    >
                        <v-list-item-icon>
        ...
        <v-app-bar app dark clipped-left dense>
            ...
            <v-spacer></v-spacer>
            <v-subheader class="d-none d-sm-flex"
                >Welcome, {{ user.username }}</v-subheader
            >
...
<script>
export default {
    props: ["user", "bugsPageId", "suggestionsPageId"],
    data: () => ({
        drawer: null,
    ...
    created() {
        ...
        if (document.querySelector("#bootstrapCSS")) {
            document
                .querySelector("#bootstrapCSS")
                .parentNode.removeChild(
                    document.querySelector("#bootstrapCSS")
                );
        }
    },
    metaInfo: {
